...
MODEL_PATH = MODEL_DIR / "risk_lstm.pt"
PRED_PATH = PRED_DIR / "pred_risk_lstm.csv"
...
def main():
    ...
    model = LSTMClassifier(input_size=X_train_s.shape[-1]).to(device)
