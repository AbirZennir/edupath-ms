              ...
              <table className="w-full">
                ...
                <tbody>
                  {atRiskStudents.map((student, index) => (
                    <tr key={student.idStudent || index} className="border-b border-[#F1F5F9] hover:bg-[#F8FAFC] transition">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          <div className="w-24 bg-[#E2E8F0] rounded-full h-2">
                            <div
                              className={`h-2 rounded-full transition-all duration-500 ${student.riskScore > 70 ? 'bg-[#EF4444]' : 'bg-[#F97316]'
                                }`}
                      ...
                      <td className="py-3 px-4">
                        <span
                          className={`px-3 py-1 rounded-full text-sm font-medium ${student.status === 'critical'
